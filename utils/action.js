...
// For chat response in chat page
export const generateChatResponse = async (chatMessage) => {
  ...
  // To check the database for the tour is there in it or not 

  export const generateTourResponse = async ({city,country}) => {
    //This part is the prompt we are giving to the AI
  ...
  export const generateTourImage = async ({city,country}) => {
    try {
      ...
      prompt : `a panoramic view of the ${city} and ${country}`,
      n:1,
      size:'512x512'
      })
